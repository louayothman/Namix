...
export function GrowthSection({ dbUser, onToggleSuccess }: GrowthSectionProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 px-6">
        ...
        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">مركز النمو</p>
      </div>
