               ...
               <div className="space-y-5 md:space-y-10 animate-in fade-in slide-in-from-left-4 duration-1000">
                  ...
                  <div className="max-h-[150px] md:max-h-[200px] overflow-y-auto pr-1 scrollbar-none">
                    <p className="text-gray-500 font-bold leading-[1.8] md:leading-[2.2] text-[10px] md:text-sm text-right whitespace-pre-wrap tracking-normal">
                       اكتشف عالم التداول اللحظي مع ناميكس. نوفر لك إمكانية الدخول المباشر إلى الأسواق العالمية وتداول الأصول الرقمية بأقل سبريد ممكن وأعلى سرعة تنفيذ في الشبكة. استعن بمحرك NAMIX AI لتحليل الرسوم البيانية واقتناص الفرص السعرية بدقة فائقة، مع ضمان توثيق كافة صفقاتك عبر سجلات العمليات اللحظية المعتمدة.
                    </p>
                  </div>

                  <div className="grid grid-cols-3 gap-2 md:gap-4">
                     {[
                       { title: "سبريد منخفض", color: "text-emerald-600", bg: "bg-emerald-50" },
                       { title: "تنفيذ وميضي", color: "text-blue-600", bg: "bg-blue-50" },
                       { title: "دعم NAMIX AI", color: "text-orange-600", bg: "bg-orange-50" }
                     ].map((item, i) => (
