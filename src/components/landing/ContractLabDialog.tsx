               ...
               <div className="space-y-2 md:space-y-4 text-right group/header">
                  <div className="relative inline-flex items-center justify-start">
                     <div className="absolute -right-6 -top-6 md:-right-10 md:-top-10 opacity-5 group-hover/header:opacity-15 group-hover/header:rotate-12 transition-all duration-700 pointer-events-none text-emerald-600">
                        <Layers size={80} className="md:size-[120px]" />
                     </div>
                  ...
                  <div className="flex items-center gap-1.5 md:gap-2 justify-start opacity-40">
                     ...
                     <p className="text-[6px] md:text-[9px] font-black text-gray-400 uppercase tracking-widest tracking-normal">Investment Protocol Node</p>
                  </div>
               </div>
               ...
               <div className="space-y-5 md:space-y-10 animate-in fade-in slide-in-from-left-4 duration-1000">
                  ...
                  <div className="max-h-[150px] md:max-h-[200px] overflow-y-auto pr-1 scrollbar-none">
                    <p className="text-gray-500 font-bold leading-[1.8] md:leading-[2.2] text-[10px] md:text-sm text-right whitespace-pre-wrap tracking-normal">
                       مختبر العقود في ناميكس هو قلب النمو المالي للمنصة. نوفر لك بيئة استثمارية مؤتمتة بالكامل تعتمد على عقود تشغيلية ذكية تولد عوائد مستقرة. يمكنك الاختيار من بين مجموعة متنوعة من الخطط الاستثمارية (بروتوكولات البداية، النمو، والنخبة) التي تناسب طموحاتك، مع ضمان شفافية كاملة وتوثيق لكافة العمليات المعتمدة.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 md:gap-4">
                     {[
                       ...
                       { title: "حماية رأس المال", color: "text-blue-600", bg: "bg-blue-50" },
                       { title: "توثيق فوري", color: "text-orange-600", bg: "bg-orange-50" }
                     ].map((item, i) => (
