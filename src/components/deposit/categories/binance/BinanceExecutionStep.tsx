      ...
      <section className="space-y-10">
         ...
         <div className="space-y-4 pt-2">
           ...
           <div className="relative h-18 rounded-[32px] bg-gray-50 border border-gray-100 overflow-hidden shadow-inner focus-within:ring-2 focus-within:ring-[#002d4d]/10 transition-all">
              <input 
                ...
                className="h-full w-full bg-transparent border-none text-center font-black text-sm px-14 outline-none text-[#002d4d] placeholder:font-bold placeholder:text-gray-300" 
         ...
         <div className="pt-4">
            <Button 
              ...
              className="w-full h-18 rounded-full bg-[#002d4d] hover:bg-[#001d33] text-white font-black text-base shadow-xl active:scale-95 flex items-center justify-center gap-3 transition-all"
            >
