    ...
    <div className="w-full space-y-8 text-right font-body animate-in fade-in duration-700" dir="rtl">
      ...
      <section className="space-y-8">
         ...
         <div className="space-y-6">
            <div className="space-y-2">
               ...
               <div className="relative">
                  <input type="number" value={amount} onChange={e => setAmount(e.target.value)} className="h-14 w-full bg-gray-50 border-none rounded-[20px] text-center font-black text-xl text-[#002d4d] shadow-inner" placeholder="0.00" />
            ...
            <div className="space-y-2">
               ...
               <div className="relative">
                  <input value={txid} onChange={e => setTxid(e.target.value)} className="h-14 w-full bg-gray-50 border-none rounded-[20px] text-center font-black text-xs text-[#002d4d] shadow-inner" placeholder="أدخل المرجع الرقمي..." />
         ...
         <div className="grid gap-4">
            <Button onClick={onSubmit} disabled={loading || !amount || !txid} className="w-full h-16 rounded-full bg-[#002d4d] text-white font-black text-base shadow-xl active:scale-95 transition-all">
