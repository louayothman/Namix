      ...
      <section className="space-y-10">
         ...
         <div className="space-y-6">
            <div className="space-y-2">
               ...
               <div className="relative h-[72px] rounded-[32px] bg-gray-50 border border-gray-100 overflow-hidden shadow-inner">
            ...
            <div className="space-y-2">
               ...
               <div className="relative h-[72px] rounded-[32px] bg-gray-50 border border-gray-100 shadow-inner">
         ...
         <div className="pt-2">
            <Button onClick={onSubmit} disabled={loading || !amount || !txid} className="w-full h-[72px] rounded-full bg-[#002d4d] hover:bg-[#001d33] text-white font-black text-base shadow-xl active:scale-95 flex items-center justify-center gap-3 transition-all">
