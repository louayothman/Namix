...
import { Search, Sparkles, ChevronLeft, Loader2, Star, Check, ArrowUpDown, X } from "lucide-react";
...
interface AssetSelectionStepProps {
  ...
  sortMode: 'popular' | 'name';
  setSortMode: (mode: 'popular' | 'name') => void;
}
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between px-4">
          ...
          <Badge className="bg-blue-50 text-blue-600 border-none font-black text-[8px] px-3 py-1 rounded-full uppercase">Crypto Inventory</Badge>
        </div>
