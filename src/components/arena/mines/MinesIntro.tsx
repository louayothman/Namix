...
/**
 * @fileOverview SOVEREIGN MINES INTRO v1000.0 - Fluid Sync Edition
    ...
    <div className="fixed inset-0 z-[200] bg-white flex flex-col items-center justify-center overflow-hidden font-body">
      ...
      <AnimatePresence>
        {(phase !== 'build' && !isExiting) && (
          <motion.div
            ...
            className="absolute h-64 w-64 rounded-full bg-blue-500 blur-[100px] pointer-events-none"
          />
        )}
      </AnimatePresence>
      ...
      <div className="relative flex flex-col items-center">
        ...
        >
          ...
          {/* قلب الهوية: تبديل شعار ناميكس بأيقونة الجوهرة (باللون الغامق) */}
          <div className="relative z-10 flex items-center justify-center">
            <AnimatePresence mode="wait">
              {(phase === 'swap' || phase === 'naming' || phase === 'stable') ? (
                ...
                >
                  <Gem size={42} className="drop-shadow-sm" />
                </motion.div>
              ) : (
                <motion.div
                  key="logo"
