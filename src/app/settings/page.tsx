              ...
              >
                {menuItems.map((item, idx) => (
                  <button 
                    ...
                    className={cn(
                      "w-full relative overflow-hidden flex items-center justify-between py-10 px-6 transition-all group active:bg-gray-50/50",
                      idx !== menuItems.length - 1 && "border-b border-gray-50"
                    )}
                  >
                     <div className="flex items-center gap-6 relative z-10 text-right">
                        <div className={cn("h-14 w-14 rounded-2xl flex items-center justify-center shadow-inner transition-all duration-500 group-hover:scale-110 bg-gray-50", item.color)}>
