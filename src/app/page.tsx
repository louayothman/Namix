...
/**
 * @fileOverview صفحة الهبوط المحدثة v21.0 - Marketing Focus
 * تصميم مينيماليست يعتمد على اللغة البسيطة والتشويق التسويقي.
 */
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-body selection:bg-[#f9a885]/30 overflow-x-hidden flex flex-col" dir="rtl">
      ...
      {/* Background Atmosphere & Floating Identity */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {/* Background Decorative Logo - Moved here for depth */}
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] scale-[2.5] md:scale-[5]">
          ...
          >
            <div className="space-y-6 pt-4">
              <div className="flex items-center justify-center gap-3">
                 ...
                 <span className="text-[10px] font-black text-blue-500/60 uppercase tracking-[0.4em] mr-[-0.4em]">بوابتك لعالم المال</span>
                 <div className="h-[0.5px] w-8 bg-blue-500/20" />
              </div>
              
              <h1 className="text-4xl md:text-7xl font-black text-[#002d4d] tracking-tighter leading-[1.1]">
                {landingData?.welcomeTitle || "ناميكس: طريقك الأسهل للنمو المالي"}
              </h1>
              
              <p className="text-gray-400 text-base md:text-xl font-medium max-w-2xl mx-auto leading-loose opacity-80">
                {landingData?.welcomeDescription || "ابدأ اليوم بتنمية أموالك من خلال أدوات بسيطة وذكية. سواء كنت ترغب في تشغيل أرباحك تلقائياً أو التداول المباشر في الأسواق العالمية، نحن نوفر لك كل ما تحتاجه للنجاح في عالم العملات الرقمية بكل شفافية ووضوح."}
              </p>
            </div>

            <div className="pt-8 flex flex-col md:flex-row items-center justify-center gap-5 w-full max-w-md px-6">
            ...
            <div className="flex items-center gap-10 opacity-20 pt-10">
               <div className="flex items-center gap-2">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-widest">تنفيذ سريع</span>
               </div>
               <div className="flex items-center gap-2">
                  <Activity size={14} className="text-blue-500" />
                  <span className="text-[8px] font-black uppercase tracking-widest">تحديث لحظي</span>
               </div>
            </div>
          </motion.div>
        </section>
