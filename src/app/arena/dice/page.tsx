...
/**
 * @fileOverview Nexus Dice v2.0 - Probability Engine
      ...
      <div className="flex flex-col h-screen bg-[#fcfdfe] font-body text-right" dir="rtl">
        ...
        <div className="flex-1 overflow-y-auto pb-32">
          <div className="max-w-xl mx-auto px-6 py-8 space-y-10">
            ...
            {/* 2. Game Reactor - Probability Matrix */}
               ...
               <AnimatePresence>
                 {lastResult !== null && (
                   <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="absolute top-6 left-1/2 -translate-x-1/2 z-30">
                      <div className={cn("px-8 py-3 rounded-2xl font-black text-3xl shadow-xl tabular-nums border-4 border-white transition-all", gameState === 'won' ? "bg-emerald-500 text-white" : "bg-red-500 text-white")}>
